...
files_list = [name for name in os.listdir(models_dir) if name.endswith(".h5")]  # ['best_model_00027_428.h5']
gif_model = 'best_model_00027_428.h5'
print(files_list)
rewards = []
...
for file in files_list:
    ...
    model.load_weights(models_dir+file)
    ...
    while True:  # Run until solved
        ...
        if episode_count % 5 == 4:
            ...
            print(f'Model {file} ended with reward {true_episode_reward} and time {true_episode_time:.2f}s')
