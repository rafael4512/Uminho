...
import ourrobots.catarina.Messages.TakeAction;
...
import static ourrobots.catarina.Utils.Utility.absoluteBearing;
import static ourrobots.catarina.Utils.Utility.normalizeBearing;
import static robocode.util.Utils.normalRelativeAngleDegrees;

public class JBourne extends TeamRobot {

    private final RobotData enemy = new RobotData();
    private final Map<String, RobotData> bots = new HashMap<>();
    private final List<String> not_hit = new ArrayList<>();
