...
public class Hulk2 extends TeamRobot implements Droid {
    private final Map<String, RobotData> mates = new HashMap<>();
    private final int border = 100;
    private boolean rogue = false;
    private final byte radarDirection = 1;
    ...
    private void doMoviment(){
        ...
        if(en != null) {
            ...
            double angle = ourrobots.catarina.Utils.Utility.absoluteBearing(getX(), getY(), pos.getX(), pos.getY());
